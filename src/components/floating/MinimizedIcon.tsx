...
export function MinimizedIcon({ onRestore }: MinimizedIconProps) {
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <button
          ...
          onClick={handleClick}
          className={cn(
            "flex items-center justify-center w-14 h-14 rounded-xl bg-[#1a1a2e] border border-primary/30 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all hover:scale-105",
